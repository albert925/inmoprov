	...
	<section id="genT">
		...
		<article class="tblus">
			<?php
				...
				$ssql="SELECT * from inmuebles where usuario_id=$idus order by cod_inm desc";
				$rs=mysql_query($ssql,$conexion) or die (mysql_error());
				$num_total_registros= mysql_num_rows($rs);
				$total_paginas= ceil($num_total_registros / $tamno_pagina);
				$gsql="SELECT * from inmuebles where usuario_id=$idus order by cod_inm desc limit $inicio, $tamno_pagina";
		...
		<article id="automargen">
			...
			<?php
				...
				?>
							<a href="inmuebles.php?pagina=<?php echo $i ?>"><?php echo "$i"; ?></a>
