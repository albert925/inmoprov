...
<body>
	...
	<article id="menuybusc" class="automar">
		<nav id="mnP">
			<ul>
				<li><a class="sel" href="">Inicio</a></li>
	...
	<section id="automargen">
		<article class="gencjflA">
			<article id="reciimb">
				<h2 id="disubdos">Inmuebles Recientes</h2>
				<ul class="grid cs-style-3">
					<?php
						$imRG="SELECT * from inmuebles where estd_inm<'3' order by cod_inm desc limit 20";
						$sql_imgr=$conexion->query($imRG) or die (mysqli_error());
						while ($xor=$sql_imgr->fetch_assoc()) {
							$idbxr=$xor['cod_inm'];
			...
			<article id="busqeydestc">
				...
				<article id="destac">
					...
					<?php
						$destaimb="SELECT * from inmuebles where estd_inm<'3' order by destac_imb desc limit 21";
